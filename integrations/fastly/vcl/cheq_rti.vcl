...
sub cheq_rti_recv {
    ...
    # Mandatory parameter is 'origin_host' (used in cheq_rti_backend_fetch) – is the customer origin hostname (e.g. www.example.com). This is needed to set the Host header of the RTI request and must match the .host value in the cheq_rti_backend declaration in your main VCL.
